...
public class StudentController {
    ...
    @GetMapping("ManagePage/ManageStudent")
    ...
    @GetMapping("ManagePage/FormInput/AddStudent")
    ...
    @PostMapping("ManagePage/FormInput/AddStudent")
    public String addStudent(@ModelAttribute("student") Student student, Model model,
        ...
        try {
            ...
            return "redirect:/StudentManager/ManagePage/ManageStudent";
    ...
    public String deleteStudent(@PathVariable Long id) {
        ...
        return "redirect:/StudentManager/ManagePage/ManageStudent"; // Chuyển hướng về trang quản lý sinh viên
    }

    // Hiển thị form sửa thông tin sinh viên
    @GetMapping("ManagePage/FormInput/EditStudent")
    public String showEditStudentForm(@RequestParam("id") Long id, Model model) {
        Student student = studentService.getStudentById(id); // Lấy thông tin giáo viên theo id
